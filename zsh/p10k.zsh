# Generated by Powerlevel10k configuration wizard on 2024-11-25 at 23:31 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=$orange
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$orange
  ...
  typeset -g POWERLEVEL9K_CPU_ARCH_BACKGROUND=$cyan
  ...
  typeset -g POWERLEVEL9K_WIFI_BACKGROUND=$cyan
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=$orange
